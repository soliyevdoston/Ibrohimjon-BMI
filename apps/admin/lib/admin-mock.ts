...
export const kpiTrends = {
  revenue:  [18, 22, 19, 26, 31, 28, 34, 30, 36, 39, 42, 48],
  orders:   [120, 140, 130, 168, 180, 172, 205, 210, 230, 222, 240, 248],
  active:   [20, 28, 32, 40, 44, 39, 42, 36, 41, 44, 40, 37],
  couriers: [40, 42, 46, 48, 44, 49, 52, 50, 53, 55, 52, 54],
};
